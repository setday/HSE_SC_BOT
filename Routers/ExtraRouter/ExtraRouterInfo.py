chat_id_text = "Это секретная команда)\n\nID твоего чата: {0}"
bot_id_text = "Это секретная команда)\n\nID бота: {0}"
fsm_state_text = "Это секретная команда)\n\nТвой state: {0}\nТвои данные: {1}"

facts_format_text = "Интересный факт №{0}:\n\n"

facts_text = [
    "Ты нашёл секретный факт!\n\nТвой код: {0}",
    "Самым сложным при создании бота было ни написание кода и ни создание его структуры, а написанеи описание Студсовета 😁",
    ...
    "Изначально над ботом работал только один человек. Сейчас над ним работает пол команды Студсовета, начиная от комитета по внешним вопросам, заканчивая SMM комитетом.",
