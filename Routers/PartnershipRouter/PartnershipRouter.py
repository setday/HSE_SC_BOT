...
class PartnershipRouter(AutoRouter):
    def __init__(self, bot: Bot) -> None:
        ...
        partners_entry_name = button_text_partnership["en"][1]
        ...
        self.add_node(
            ...
            node_trigger_callback=self.sent_entry_func,
        )

        self.convert_to_entry_node(partners_entry_name)

        self.add_message_edge(partners_entry_name, "partners_message_review")
        ...
        self.add_button_edge(partners_entry_name, ExtraAutoNodes.HOME_NODE)
